...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 33 78 10 80 	movl   $0x80107833,(%esp)
...
8010386e:	e8 7d 32 00 00       	call   80106af0 <copyuvm>
80103873:	85 c0                	test   %eax,%eax
80103875:	89 47 08             	mov    %eax,0x8(%edi)
...
80103897:	8b 43 04             	mov    0x4(%ebx),%eax
8010389a:	89 42 04             	mov    %eax,0x4(%edx)
  np->tf->eax = 0;
...
80103e74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e78:	c7 04 24 33 78 10 80 	movl   $0x80107833,(%esp)
...
80105512:	0f 84 e8 01 00 00    	je     80105700 <trap+0x200>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105520:	ff 24 85 b4 76 10 80 	jmp    *-0x7fef894c(,%eax,4)
80105527:	90                   	nop
    break;
  //////////////LAB 3
...
8010552f:	90                   	nop
80105530:	0f 84 62 02 00 00    	je     80105798 <trap+0x298>
80105536:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010553a:	0f 84 58 02 00 00    	je     80105798 <trap+0x298>
...
80105593:	c7 04 24 70 76 10 80 	movl   $0x80107670,(%esp)
...
80105643:	e8 48 e0 ff ff       	call   80103690 <myproc>
    address = PGROUNDDOWN(address);
80105648:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if(allocuvm(myproc()->pgdir, address, address + PGSIZE) == 0){
8010564e:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
80105654:	89 54 24 08          	mov    %edx,0x8(%esp)
80105658:	89 74 24 04          	mov    %esi,0x4(%esp)
8010565c:	8b 40 08             	mov    0x8(%eax),%eax
8010565f:	89 04 24             	mov    %eax,(%esp)
80105662:	e8 09 12 00 00       	call   80106870 <allocuvm>
80105667:	85 c0                	test   %eax,%eax
80105669:	0f 85 c9 00 00 00    	jne    80105738 <trap+0x238>
      cprintf("fault is caused by an access to an unmapped page\n");
8010566f:	c7 04 24 08 76 10 80 	movl   $0x80107608,(%esp)
80105676:	e8 d5 af ff ff       	call   80100650 <cprintf>
8010567b:	e9 30 ff ff ff       	jmp    801055b0 <trap+0xb0>
    if(cpuid() == 0){
80105680:	e8 eb df ff ff       	call   80103670 <cpuid>
80105685:	85 c0                	test   %eax,%eax
80105687:	0f 84 db 00 00 00    	je     80105768 <trap+0x268>
...
801056cc:	c7 04 24 e4 75 10 80 	movl   $0x801075e4,(%esp)
...
801056e4:	eb a7                	jmp    8010568d <trap+0x18d>
801056e6:	66 90                	xchg   %ax,%ax
    ideintr();
801056e8:	e8 83 c9 ff ff       	call   80102070 <ideintr>
801056ed:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
801056f0:	e8 7b d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056f5:	e9 b6 fe ff ff       	jmp    801055b0 <trap+0xb0>
...
8010570a:	75 4c                	jne    80105758 <trap+0x258>
    myproc()->tf = tf;
...
80105735:	8d 76 00             	lea    0x0(%esi),%esi
      myproc()->stack_size++;
80105738:	e8 53 df ff ff       	call   80103690 <myproc>
8010573d:	83 40 04 01          	addl   $0x1,0x4(%eax)
      cprintf("Increased stack size\n");
80105741:	c7 04 24 c6 75 10 80 	movl   $0x801075c6,(%esp)
80105748:	e8 03 af ff ff       	call   80100650 <cprintf>
8010574d:	e9 5e fe ff ff       	jmp    801055b0 <trap+0xb0>
80105752:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105758:	e8 33 e3 ff ff       	call   80103a90 <exit>
8010575d:	8d 76 00             	lea    0x0(%esi),%esi
80105760:	eb aa                	jmp    8010570c <trap+0x20c>
80105762:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105768:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010576f:	e8 bc e9 ff ff       	call   80104130 <acquire>
      wakeup(&ticks);
80105774:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
8010577b:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105782:	e8 f9 e5 ff ff       	call   80103d80 <wakeup>
      release(&tickslock);
80105787:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010578e:	e8 8d ea ff ff       	call   80104220 <release>
80105793:	e9 f5 fe ff ff       	jmp    8010568d <trap+0x18d>
80105798:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010579b:	8b 73 38             	mov    0x38(%ebx),%esi
8010579e:	e8 cd de ff ff       	call   80103670 <cpuid>
...
801057b2:	c7 04 24 3c 76 10 80 	movl   $0x8010763c,(%esp)
801057b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801057bd:	e8 8e ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057c2:	c7 04 24 dc 75 10 80 	movl   $0x801075dc,(%esp)
...
801058b7:	00 
  for(p="xv6...\n"; *p; p++)
801058b8:	bb 7c 77 10 80       	mov    $0x8010777c,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105906:	6a 00                	push   $0x0
  jmp alltraps
80105908:	e9 00 fb ff ff       	jmp    8010540d <alltraps>
...
8010590f:	6a 01                	push   $0x1
  jmp alltraps
80105911:	e9 f7 fa ff ff       	jmp    8010540d <alltraps>
...
80105933:	6a 05                	push   $0x5
  jmp alltraps
80105935:	e9 d3 fa ff ff       	jmp    8010540d <alltraps>
...
8010593c:	6a 06                	push   $0x6
  jmp alltraps
8010593e:	e9 ca fa ff ff       	jmp    8010540d <alltraps>
...
80105945:	6a 07                	push   $0x7
  jmp alltraps
80105947:	e9 c1 fa ff ff       	jmp    8010540d <alltraps>
...
80105963:	6a 0b                	push   $0xb
  jmp alltraps
80105965:	e9 a3 fa ff ff       	jmp    8010540d <alltraps>
...
80105971:	6a 0d                	push   $0xd
  jmp alltraps
80105973:	e9 95 fa ff ff       	jmp    8010540d <alltraps>
...
80105978:	6a 0e                	push   $0xe
  jmp alltraps
8010597a:	e9 8e fa ff ff       	jmp    8010540d <alltraps>
...
80105981:	6a 0f                	push   $0xf
  jmp alltraps
80105983:	e9 85 fa ff ff       	jmp    8010540d <alltraps>
...
8010599a:	6a 12                	push   $0x12
  jmp alltraps
8010599c:	e9 6c fa ff ff       	jmp    8010540d <alltraps>
...
801059ac:	6a 14                	push   $0x14
  jmp alltraps
801059ae:	e9 5a fa ff ff       	jmp    8010540d <alltraps>
...
801059b5:	6a 15                	push   $0x15
  jmp alltraps
801059b7:	e9 51 fa ff ff       	jmp    8010540d <alltraps>
...
801059be:	6a 16                	push   $0x16
  jmp alltraps
801059c0:	e9 48 fa ff ff       	jmp    8010540d <alltraps>
...
801059c7:	6a 17                	push   $0x17
  jmp alltraps
801059c9:	e9 3f fa ff ff       	jmp    8010540d <alltraps>
...
801059d0:	6a 18                	push   $0x18
  jmp alltraps
801059d2:	e9 36 fa ff ff       	jmp    8010540d <alltraps>
...
801059d9:	6a 19                	push   $0x19
  jmp alltraps
801059db:	e9 2d fa ff ff       	jmp    8010540d <alltraps>
...
801059e2:	6a 1a                	push   $0x1a
  jmp alltraps
801059e4:	e9 24 fa ff ff       	jmp    8010540d <alltraps>
...
801059eb:	6a 1b                	push   $0x1b
  jmp alltraps
801059ed:	e9 1b fa ff ff       	jmp    8010540d <alltraps>
...
801059f4:	6a 1c                	push   $0x1c
  jmp alltraps
801059f6:	e9 12 fa ff ff       	jmp    8010540d <alltraps>
...
801059fd:	6a 1d                	push   $0x1d
  jmp alltraps
801059ff:	e9 09 fa ff ff       	jmp    8010540d <alltraps>
...
80105a06:	6a 1e                	push   $0x1e
  jmp alltraps
80105a08:	e9 00 fa ff ff       	jmp    8010540d <alltraps>
...
80105a0f:	6a 1f                	push   $0x1f
  jmp alltraps
80105a11:	e9 f7 f9 ff ff       	jmp    8010540d <alltraps>
...
80105a18:	6a 20                	push   $0x20
  jmp alltraps
80105a1a:	e9 ee f9 ff ff       	jmp    8010540d <alltraps>
...
80105a21:	6a 21                	push   $0x21
  jmp alltraps
80105a23:	e9 e5 f9 ff ff       	jmp    8010540d <alltraps>
...
80105a33:	6a 23                	push   $0x23
  jmp alltraps
80105a35:	e9 d3 f9 ff ff       	jmp    8010540d <alltraps>
...
80105a3c:	6a 24                	push   $0x24
  jmp alltraps
80105a3e:	e9 ca f9 ff ff       	jmp    8010540d <alltraps>
...
80105a45:	6a 25                	push   $0x25
  jmp alltraps
80105a47:	e9 c1 f9 ff ff       	jmp    8010540d <alltraps>
...
80105a4e:	6a 26                	push   $0x26
  jmp alltraps
80105a50:	e9 b8 f9 ff ff       	jmp    8010540d <alltraps>
...
80105a57:	6a 27                	push   $0x27
  jmp alltraps
80105a59:	e9 af f9 ff ff       	jmp    8010540d <alltraps>
...
80105a60:	6a 28                	push   $0x28
  jmp alltraps
80105a62:	e9 a6 f9 ff ff       	jmp    8010540d <alltraps>
...
80105a69:	6a 29                	push   $0x29
  jmp alltraps
80105a6b:	e9 9d f9 ff ff       	jmp    8010540d <alltraps>
...
80105a72:	6a 2a                	push   $0x2a
  jmp alltraps
80105a74:	e9 94 f9 ff ff       	jmp    8010540d <alltraps>
...
80105a7b:	6a 2b                	push   $0x2b
  jmp alltraps
80105a7d:	e9 8b f9 ff ff       	jmp    8010540d <alltraps>
...
80105a84:	6a 2c                	push   $0x2c
  jmp alltraps
80105a86:	e9 82 f9 ff ff       	jmp    8010540d <alltraps>
...
80105a8d:	6a 2d                	push   $0x2d
  jmp alltraps
80105a8f:	e9 79 f9 ff ff       	jmp    8010540d <alltraps>
...
80105a96:	6a 2e                	push   $0x2e
  jmp alltraps
80105a98:	e9 70 f9 ff ff       	jmp    8010540d <alltraps>
...
80105a9f:	6a 2f                	push   $0x2f
  jmp alltraps
80105aa1:	e9 67 f9 ff ff       	jmp    8010540d <alltraps>
...
80105aa8:	6a 30                	push   $0x30
  jmp alltraps
80105aaa:	e9 5e f9 ff ff       	jmp    8010540d <alltraps>
...
80105ab1:	6a 31                	push   $0x31
  jmp alltraps
80105ab3:	e9 55 f9 ff ff       	jmp    8010540d <alltraps>
...
80105aba:	6a 32                	push   $0x32
  jmp alltraps
80105abc:	e9 4c f9 ff ff       	jmp    8010540d <alltraps>
...
80105ac3:	6a 33                	push   $0x33
  jmp alltraps
80105ac5:	e9 43 f9 ff ff       	jmp    8010540d <alltraps>
...
80105acc:	6a 34                	push   $0x34
  jmp alltraps
80105ace:	e9 3a f9 ff ff       	jmp    8010540d <alltraps>
...
80105ad5:	6a 35                	push   $0x35
  jmp alltraps
80105ad7:	e9 31 f9 ff ff       	jmp    8010540d <alltraps>
...
80105ade:	6a 36                	push   $0x36
  jmp alltraps
80105ae0:	e9 28 f9 ff ff       	jmp    8010540d <alltraps>
...
80105ae7:	6a 37                	push   $0x37
  jmp alltraps
80105ae9:	e9 1f f9 ff ff       	jmp    8010540d <alltraps>
...
80105af0:	6a 38                	push   $0x38
  jmp alltraps
80105af2:	e9 16 f9 ff ff       	jmp    8010540d <alltraps>
...
80105af9:	6a 39                	push   $0x39
  jmp alltraps
80105afb:	e9 0d f9 ff ff       	jmp    8010540d <alltraps>
...
80105b02:	6a 3a                	push   $0x3a
  jmp alltraps
80105b04:	e9 04 f9 ff ff       	jmp    8010540d <alltraps>
...
80105b0b:	6a 3b                	push   $0x3b
  jmp alltraps
80105b0d:	e9 fb f8 ff ff       	jmp    8010540d <alltraps>
...
80105b14:	6a 3c                	push   $0x3c
  jmp alltraps
80105b16:	e9 f2 f8 ff ff       	jmp    8010540d <alltraps>
...
80105b1d:	6a 3d                	push   $0x3d
  jmp alltraps
80105b1f:	e9 e9 f8 ff ff       	jmp    8010540d <alltraps>
...
80105b26:	6a 3e                	push   $0x3e
  jmp alltraps
80105b28:	e9 e0 f8 ff ff       	jmp    8010540d <alltraps>
...
80105b2f:	6a 3f                	push   $0x3f
  jmp alltraps
80105b31:	e9 d7 f8 ff ff       	jmp    8010540d <alltraps>
...
80105b38:	6a 40                	push   $0x40
  jmp alltraps
80105b3a:	e9 ce f8 ff ff       	jmp    8010540d <alltraps>
...
80105b41:	6a 41                	push   $0x41
  jmp alltraps
80105b43:	e9 c5 f8 ff ff       	jmp    8010540d <alltraps>
...
80105b4a:	6a 42                	push   $0x42
  jmp alltraps
80105b4c:	e9 bc f8 ff ff       	jmp    8010540d <alltraps>
...
80105b53:	6a 43                	push   $0x43
  jmp alltraps
80105b55:	e9 b3 f8 ff ff       	jmp    8010540d <alltraps>
...
80105b5c:	6a 44                	push   $0x44
  jmp alltraps
80105b5e:	e9 aa f8 ff ff       	jmp    8010540d <alltraps>
...
80105b65:	6a 45                	push   $0x45
  jmp alltraps
80105b67:	e9 a1 f8 ff ff       	jmp    8010540d <alltraps>
...
80105b6e:	6a 46                	push   $0x46
  jmp alltraps
80105b70:	e9 98 f8 ff ff       	jmp    8010540d <alltraps>
...
80105b77:	6a 47                	push   $0x47
  jmp alltraps
80105b79:	e9 8f f8 ff ff       	jmp    8010540d <alltraps>
...
80105b80:	6a 48                	push   $0x48
  jmp alltraps
80105b82:	e9 86 f8 ff ff       	jmp    8010540d <alltraps>
...
80105b89:	6a 49                	push   $0x49
  jmp alltraps
80105b8b:	e9 7d f8 ff ff       	jmp    8010540d <alltraps>
...
80105b92:	6a 4a                	push   $0x4a
  jmp alltraps
80105b94:	e9 74 f8 ff ff       	jmp    8010540d <alltraps>
...
80105b9b:	6a 4b                	push   $0x4b
  jmp alltraps
80105b9d:	e9 6b f8 ff ff       	jmp    8010540d <alltraps>
...
80105ba4:	6a 4c                	push   $0x4c
  jmp alltraps
80105ba6:	e9 62 f8 ff ff       	jmp    8010540d <alltraps>
...
80105bad:	6a 4d                	push   $0x4d
  jmp alltraps
80105baf:	e9 59 f8 ff ff       	jmp    8010540d <alltraps>
...
80105bb6:	6a 4e                	push   $0x4e
  jmp alltraps
80105bb8:	e9 50 f8 ff ff       	jmp    8010540d <alltraps>
...
80105bbf:	6a 4f                	push   $0x4f
  jmp alltraps
80105bc1:	e9 47 f8 ff ff       	jmp    8010540d <alltraps>
...
80105bc8:	6a 50                	push   $0x50
  jmp alltraps
80105bca:	e9 3e f8 ff ff       	jmp    8010540d <alltraps>
...
80105bd1:	6a 51                	push   $0x51
  jmp alltraps
80105bd3:	e9 35 f8 ff ff       	jmp    8010540d <alltraps>
...
80105bda:	6a 52                	push   $0x52
  jmp alltraps
80105bdc:	e9 2c f8 ff ff       	jmp    8010540d <alltraps>
...
80105be3:	6a 53                	push   $0x53
  jmp alltraps
80105be5:	e9 23 f8 ff ff       	jmp    8010540d <alltraps>
...
80105bec:	6a 54                	push   $0x54
  jmp alltraps
80105bee:	e9 1a f8 ff ff       	jmp    8010540d <alltraps>
...
80105bf5:	6a 55                	push   $0x55
  jmp alltraps
80105bf7:	e9 11 f8 ff ff       	jmp    8010540d <alltraps>
...
80105bfe:	6a 56                	push   $0x56
  jmp alltraps
80105c00:	e9 08 f8 ff ff       	jmp    8010540d <alltraps>
...
80105c07:	6a 57                	push   $0x57
  jmp alltraps
80105c09:	e9 ff f7 ff ff       	jmp    8010540d <alltraps>
...
80105c10:	6a 58                	push   $0x58
  jmp alltraps
80105c12:	e9 f6 f7 ff ff       	jmp    8010540d <alltraps>
...
80105c19:	6a 59                	push   $0x59
  jmp alltraps
80105c1b:	e9 ed f7 ff ff       	jmp    8010540d <alltraps>
...
80105c22:	6a 5a                	push   $0x5a
  jmp alltraps
80105c24:	e9 e4 f7 ff ff       	jmp    8010540d <alltraps>
...
80105c2b:	6a 5b                	push   $0x5b
  jmp alltraps
80105c2d:	e9 db f7 ff ff       	jmp    8010540d <alltraps>
...
80105c34:	6a 5c                	push   $0x5c
  jmp alltraps
80105c36:	e9 d2 f7 ff ff       	jmp    8010540d <alltraps>
...
80105c3d:	6a 5d                	push   $0x5d
  jmp alltraps
80105c3f:	e9 c9 f7 ff ff       	jmp    8010540d <alltraps>
...
80105c46:	6a 5e                	push   $0x5e
  jmp alltraps
80105c48:	e9 c0 f7 ff ff       	jmp    8010540d <alltraps>
...
80105c4f:	6a 5f                	push   $0x5f
  jmp alltraps
80105c51:	e9 b7 f7 ff ff       	jmp    8010540d <alltraps>
...
80105c58:	6a 60                	push   $0x60
  jmp alltraps
80105c5a:	e9 ae f7 ff ff       	jmp    8010540d <alltraps>
...
80105c61:	6a 61                	push   $0x61
  jmp alltraps
80105c63:	e9 a5 f7 ff ff       	jmp    8010540d <alltraps>
...
80105c6a:	6a 62                	push   $0x62
  jmp alltraps
80105c6c:	e9 9c f7 ff ff       	jmp    8010540d <alltraps>
...
80105c73:	6a 63                	push   $0x63
  jmp alltraps
80105c75:	e9 93 f7 ff ff       	jmp    8010540d <alltraps>
...
80105c7c:	6a 64                	push   $0x64
  jmp alltraps
80105c7e:	e9 8a f7 ff ff       	jmp    8010540d <alltraps>
...
80105c85:	6a 65                	push   $0x65
  jmp alltraps
80105c87:	e9 81 f7 ff ff       	jmp    8010540d <alltraps>
...
80105c8e:	6a 66                	push   $0x66
  jmp alltraps
80105c90:	e9 78 f7 ff ff       	jmp    8010540d <alltraps>
...
80105c97:	6a 67                	push   $0x67
  jmp alltraps
80105c99:	e9 6f f7 ff ff       	jmp    8010540d <alltraps>
...
80105ca0:	6a 68                	push   $0x68
  jmp alltraps
80105ca2:	e9 66 f7 ff ff       	jmp    8010540d <alltraps>
...
80105ca9:	6a 69                	push   $0x69
  jmp alltraps
80105cab:	e9 5d f7 ff ff       	jmp    8010540d <alltraps>
...
80105cb2:	6a 6a                	push   $0x6a
  jmp alltraps
80105cb4:	e9 54 f7 ff ff       	jmp    8010540d <alltraps>
...
80105cbb:	6a 6b                	push   $0x6b
  jmp alltraps
80105cbd:	e9 4b f7 ff ff       	jmp    8010540d <alltraps>
...
80105cc4:	6a 6c                	push   $0x6c
  jmp alltraps
80105cc6:	e9 42 f7 ff ff       	jmp    8010540d <alltraps>
...
80105ccd:	6a 6d                	push   $0x6d
  jmp alltraps
80105ccf:	e9 39 f7 ff ff       	jmp    8010540d <alltraps>
...
80105cd6:	6a 6e                	push   $0x6e
  jmp alltraps
80105cd8:	e9 30 f7 ff ff       	jmp    8010540d <alltraps>
...
80105cdf:	6a 6f                	push   $0x6f
  jmp alltraps
80105ce1:	e9 27 f7 ff ff       	jmp    8010540d <alltraps>
...
80105ce8:	6a 70                	push   $0x70
  jmp alltraps
80105cea:	e9 1e f7 ff ff       	jmp    8010540d <alltraps>
...
80105cf1:	6a 71                	push   $0x71
  jmp alltraps
80105cf3:	e9 15 f7 ff ff       	jmp    8010540d <alltraps>
...
80105cfa:	6a 72                	push   $0x72
  jmp alltraps
80105cfc:	e9 0c f7 ff ff       	jmp    8010540d <alltraps>
...
80105d03:	6a 73                	push   $0x73
  jmp alltraps
80105d05:	e9 03 f7 ff ff       	jmp    8010540d <alltraps>
...
80105d0c:	6a 74                	push   $0x74
  jmp alltraps
80105d0e:	e9 fa f6 ff ff       	jmp    8010540d <alltraps>
...
80105d15:	6a 75                	push   $0x75
  jmp alltraps
80105d17:	e9 f1 f6 ff ff       	jmp    8010540d <alltraps>
...
80105d1e:	6a 76                	push   $0x76
  jmp alltraps
80105d20:	e9 e8 f6 ff ff       	jmp    8010540d <alltraps>
...
80105d30:	6a 78                	push   $0x78
  jmp alltraps
80105d32:	e9 d6 f6 ff ff       	jmp    8010540d <alltraps>
...
80105d39:	6a 79                	push   $0x79
  jmp alltraps
80105d3b:	e9 cd f6 ff ff       	jmp    8010540d <alltraps>
...
80105d42:	6a 7a                	push   $0x7a
  jmp alltraps
80105d44:	e9 c4 f6 ff ff       	jmp    8010540d <alltraps>
...
80105d54:	6a 7c                	push   $0x7c
  jmp alltraps
80105d56:	e9 b2 f6 ff ff       	jmp    8010540d <alltraps>
...
80105d5d:	6a 7d                	push   $0x7d
  jmp alltraps
80105d5f:	e9 a9 f6 ff ff       	jmp    8010540d <alltraps>
...
80105d66:	6a 7e                	push   $0x7e
  jmp alltraps
80105d68:	e9 a0 f6 ff ff       	jmp    8010540d <alltraps>
...
801065e1:	c3                   	ret    
      panic("remap");
801065e2:	c7 04 24 84 77 10 80 	movl   $0x80107784,(%esp)
...
801066f1:	c7 04 24 8a 77 10 80 	movl   $0x8010778a,(%esp)
801066f8:	e8 63 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801066fd:	c7 04 24 b5 77 10 80 	movl   $0x801077b5,(%esp)
80106704:	e8 57 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106709:	c7 04 24 a0 77 10 80 	movl   $0x801077a0,(%esp)
...
8010679e:	c7 04 24 c9 77 10 80 	movl   $0x801077c9,(%esp)
...
80106852:	c7 04 24 e3 77 10 80 	movl   $0x801077e3,(%esp)
80106859:	e8 02 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010685e:	c7 04 24 84 78 10 80 	movl   $0x80107884,(%esp)
...
80106902:	c7 04 24 01 78 10 80 	movl   $0x80107801,(%esp)
...
80106930:	c7 04 24 19 78 10 80 	movl   $0x80107819,(%esp)
...
801069f3:	e9 e8 b8 ff ff       	jmp    801022e0 <kfree>
    panic("freevm: no pgdir");
801069f8:	c7 04 24 35 78 10 80 	movl   $0x80107835,(%esp)
...
80106adb:	c3                   	ret    
    panic("clearpteu");
80106adc:	c7 04 24 46 78 10 80 	movl   $0x80107846,(%esp)
...
80106b03:	0f 84 8d 01 00 00    	je     80106c96 <copyuvm+0x1a6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106b77:	0f 84 2c 01 00 00    	je     80106ca9 <copyuvm+0x1b9>
    if(!(*pte & PTE_P))
80106b7d:	8b 30                	mov    (%eax),%esi
80106b7f:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b85:	0f 84 12 01 00 00    	je     80106c9d <copyuvm+0x1ad>
    pa = PTE_ADDR(*pte);
...
80106bbf:	c3                   	ret    
  struct proc *curproc = myproc();
80106bc0:	e8 cb ca ff ff       	call   80103690 <myproc>
80106bc5:	89 45 dc             	mov    %eax,-0x24(%ebp)
    for(i = k; i > k - (curproc->stack_size) * PGSIZE; i -= PGSIZE){
80106bc8:	8b 40 04             	mov    0x4(%eax),%eax
80106bcb:	f7 d8                	neg    %eax
80106bcd:	c1 e0 0c             	shl    $0xc,%eax
80106bd0:	05 00 f0 ff 7f       	add    $0x7ffff000,%eax
80106bd5:	3d ff ef ff 7f       	cmp    $0x7fffefff,%eax
80106bda:	0f 87 ab 00 00 00    	ja     80106c8b <copyuvm+0x19b>
80106be0:	bb 00 f0 ff 7f       	mov    $0x7ffff000,%ebx
80106be5:	eb 65                	jmp    80106c4c <copyuvm+0x15c>
80106be7:	90                   	nop
    memmove(mem, (char*)P2V(pa), PGSIZE);
...
80106bfd:	e8 0e d7 ff ff       	call   80104310 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106c02:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106c05:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106c0b:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106c0f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c16:	00 
80106c17:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106c1b:	89 44 24 10          	mov    %eax,0x10(%esp)
80106c1f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c22:	89 04 24             	mov    %eax,(%esp)
80106c25:	e8 46 f9 ff ff       	call   80106570 <mappages>
80106c2a:	85 c0                	test   %eax,%eax
80106c2c:	0f 88 79 ff ff ff    	js     80106bab <copyuvm+0xbb>
    for(i = k; i > k - (curproc->stack_size) * PGSIZE; i -= PGSIZE){
80106c32:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106c35:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
...
80106c48:	39 d8                	cmp    %ebx,%eax
80106c4a:	73 3f                	jae    80106c8b <copyuvm+0x19b>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
...
80106c5a:	74 4d                	je     80106ca9 <copyuvm+0x1b9>
    if(!(*pte & PTE_P))
80106c5c:	8b 30                	mov    (%eax),%esi
80106c5e:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c64:	74 37                	je     80106c9d <copyuvm+0x1ad>
    pa = PTE_ADDR(*pte);
80106c66:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c68:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c6e:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c71:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106c77:	e8 14 b8 ff ff       	call   80102490 <kalloc>
80106c7c:	85 c0                	test   %eax,%eax
80106c7e:	89 c6                	mov    %eax,%esi
80106c80:	0f 85 62 ff ff ff    	jne    80106be8 <copyuvm+0xf8>
80106c86:	e9 20 ff ff ff       	jmp    80106bab <copyuvm+0xbb>
...
80106c98:	e9 1b ff ff ff       	jmp    80106bb8 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106c9d:	c7 04 24 6a 78 10 80 	movl   $0x8010786a,(%esp)
80106ca4:	e8 b7 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106ca9:	c7 04 24 50 78 10 80 	movl   $0x80107850,(%esp)
...
80106d96:	c7 44 24 04 a8 78 10 	movl   $0x801078a8,0x4(%esp)
80106d9d:	80 
